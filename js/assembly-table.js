function plotAssemblyTable(json) {
    ...
    if (!hasScaffolds) {
        ...
        var rowMap = {
            ...
            'Percentage of sequences (>= 1k nt) (%)': ['Percentage of contigs (>= 1k nt) (%)'],
            'Percentage of sequences (>= 10k nt) (%)': ['Percentage of contigs (>= 10k nt) (%)'],
            'Percentage of sequences (>= 100k nt) (%)': ['Percentage of contigs (>= 100k nt) (%)'],
            'Percentage of sequences (>= 1M nt) (%)': ['Percentage of contigs (>= 1M nt) (%)'],
            'Percentage of sequences (>= 10M nt) (%)': ['Percentage of contigs (>= 10M nt) (%)'],
            'Mean sequence size': ['Mean contig size'],
            'Median sequence size': ['Mean contig size'],
            ' A (%)': ['Contig A (%)'],
            ' C (%)': ['Contig C (%)'],
            ' G (%)': ['Contig G (%)'],
            ' T (%)': ['Contig T (%)'],
        ...
        var rowMap = {
            ...
            'Percentage of sequences (>= 1k nt) (%)': ['Percentage of scaffolds (>= 1k nt) (%)'],
            'Percentage of sequences (>= 10k nt) (%)': ['Percentage of scaffolds (>= 10k nt) (%)'],
            'Percentage of sequences (>= 100k nt) (%)': ['Percentage of scaffolds (>= 100k nt) (%)'],
            'Percentage of sequences (>= 1M nt) (%)': ['Percentage of scaffolds (>= 1M nt) (%)'],
            'Percentage of sequences (>= 10M nt) (%)': ['Percentage of scaffolds (>= 10M nt) (%)'],
        ...
        var rowMap = {
            ...
            'Percentage of sequences (>= 1k nt) (%)': ['Percentage of scaffolds (>= 1k nt) (%)', 'Percentage of contigs (>= 1k nt) (%)'],
            'Percentage of sequences (>= 10k nt) (%)': ['Percentage of scaffolds (>= 10k nt) (%)', 'Percentage of contigs (>= 10k nt) (%)'],
            'Percentage of sequences (>= 100k nt) (%)': ['Percentage of scaffolds (>= 100k nt) (%)', 'Percentage of contigs (>= 100k nt) (%)'],
            'Percentage of sequences (>= 1M nt) (%)': ['Percentage of scaffolds (>= 1M nt) (%)', 'Percentage of contigs (>= 1M nt) (%)'],
            'Percentage of sequences (>= 10M nt) (%)': ['Percentage of scaffolds (>= 10M nt) (%)', 'Percentage of contigs (>= 10M nt) (%)'],
            'Mean sequence size': ['Mean scaffold size', 'Mean contig size'],
            'Median sequence size': ['Median scaffold size', 'Mean contig size'],
    ...
    var rowNames = [
        ...
        'Percentage of sequences (>= 1k nt) (%)',
        'Percentage of sequences (>= 10k nt) (%)',
        'Percentage of sequences (>= 100k nt) (%)',
        'Percentage of sequences (>= 1M nt) (%)',
        'Percentage of sequences (>= 10M nt) (%)',
        'Mean sequence size',
